...
(() => {
  ...
  function render() {
    ...
    footer.append('. Fork Microscope is an independent workbench; attribution does not imply endorsement. ',link('Source code','https://github.com/iPolluxx/fork-microscope'),' · ',link('Get started','https://github.com/iPolluxx/fork-microscope/blob/main/docs/GETTING-STARTED.md'));
  }
  function init() {
