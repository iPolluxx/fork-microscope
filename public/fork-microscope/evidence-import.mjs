...
input?.addEventListener('change', async () => {
  ...
  try {
    ...
    status.textContent = 'Checking and importing saved evidence…';
    ...
    status.textContent = value.already_present ? 'Already saved here. Opening the run…' : 'Evidence imported. Opening the run…';
