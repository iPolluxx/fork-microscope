...
ASSETS=('workspace.html workspace.mjs workspace.css live.html live.js live.css '
        ...
        'refinement-panel.css evidence-import.mjs graph-evidence.mjs passes.mjs '
        'math.mjs plotly.min.js app.js styles.css').split()
...
def build(destination=None):
    ...
    with tempfile.TemporaryDirectory(prefix='.dashboard-build-',dir=target.parent) as staging:
        ...
        shutil.copy2(source/'index.html',stage/'released-data.html')
